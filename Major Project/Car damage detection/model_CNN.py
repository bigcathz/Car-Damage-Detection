...
path1 = 'E:/New Projects Code/New Topics 2023/vehicle damage detection 100% code/vehicle damage detection 100% code/archive (10)/data1a/training/01-whole'    #path of folder of images    
path2 = 'E:/New Projects Code/New Topics 2023/vehicle damage detection 100% code/vehicle damage detection 100% code/test_set/1'  #path of folder to save images    
